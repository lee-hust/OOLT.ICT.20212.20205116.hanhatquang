...
//		thread.start();
        ...
        boolean runmediaDetailsMenu = true;
        ...
        Book book1 = new Book("Doremon", "comic", "i can can the can but the can cannot can me", 15, "nhat quang", "ha");
        Book book2 = new Book("Conan", "comic", "hi hi hi hi", 18, "nhat quang", "ha");
        Book book3 = new Book("Conan", "comic", "hello world", 18, "nhat quang", "ha");
        Track track1 = new Track(24, "Ha");
        Track track2 = new Track(34, "Nhat");
        Track track3 = new Track(56, "Quang");
        CompactDisc cd1 = new CompactDisc("quang", "music", "viet", 2.5f, "thi", track1, track2);
        CompactDisc cd2 = new CompactDisc("ha", "music", "viet", 2.5f, "thi", track1, track2);
        CompactDisc cd3 = new CompactDisc("nhat", "music", "viet", 2.5f, "thi", track1, track2);
        cd3.addTrack(track3);
        book1.addAuthor("quang", "nhat");
        book2.removeAuthor("ha");
                    ...
                    while (runStoreMenu) {
                        ...
                        switch (choice) {
                            ...
                            case 2:
                                ...
                                System.out.println("Enter the ID of the media");
                                int id = Integer.parseInt(input.nextLine());
                                Media media = store.searchByID(Integer.parseInt(input.nextLine()));
                                if (media == null) {
